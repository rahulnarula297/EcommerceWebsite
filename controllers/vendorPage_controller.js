        ...
        if(req.xhr) {
            Profile.uploadedAvatar(req, res, function(err) {
                ...
                Profile.create({
                    ...
                    //nodemailer setup when user first time creates profile 
                    const transporter = nodemailer.createTransport({
                        service:"gmail",
                        auth: {
                            user:"rahulfullstack297@gmail.com",
                            pass:"Rahul@2041233864"

                        }
                    });

                    const data= await ejs.renderFile( "./views/mailers/vendor.ejs",{profile:profile});

                    const options = {
                        from:"rahulfullstack297@gmail.com",
                        to:profile.email,
                        subject:"nodemailer sucessfull setup",
                        // text:"welcome onboard , you have successfully set up you profile. bro itni bhi ki narazgi janeman"
                        html:data
                    };
